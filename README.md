...
The actuator features an 8:1 reduction ratio, meaning the motor must rotate eight times for the output shaft to complete one full revolution. This reduction increases the output torque while lowering the rotational speed, which is ideal for robotic joints requiring high torque and precise control. <br>
...
This means that one full revolution of the motor causes the output shaft to rotate 1/8 of a turn, providing roughly eight times the motor’s torque at the output.
